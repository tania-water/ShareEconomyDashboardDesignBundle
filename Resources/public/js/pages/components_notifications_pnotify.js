...
$(function() {
    ...
    $('#pnotify-styled-left').on('click', function () {
        new PNotify({
            title: 'Left icon',
            text: 'Check me out! I\'m a notice.',
            addclass: 'alert alert-styled-left stack-top-right',
            type: 'info',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-styled-right').on('click', function () {
        new PNotify({
            title: 'Right icon',
            text: 'Check me out! I\'m a notice.',
            addclass: 'alert alert-warning alert-styled-right stack-top-right',
            type: 'error',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-custom-styled').on('click', function () {
        new PNotify({
            ...
            text: 'Check me out! I\'m a notice.',
            addclass: 'alert alert-styled-left alert-styled-custom alert-arrow-left alpha-teal text-teal-800 stack-top-right',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-solid-primary').on('click', function () {
        new PNotify({
            title: 'Primary notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'bg-primary stack-top-right',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-solid-warning').on('click', function () {
        new PNotify({
            ...
            text: 'Check me out! I\'m a notice.',
            addclass: 'bg-warning stack-top-right',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-solid-custom').on('click', function () {
        new PNotify({
            title: 'Custom color notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'bg-teal stack-top-right',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-solid-styled-left').on('click', function () {
        new PNotify({
            title: 'Left icon',
            text: 'Check me out! I\'m a notice.',
            addclass: 'alert bg-primary alert-styled-left stack-top-right',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-solid-styled-right').on('click', function () {
        new PNotify({
            title: 'Right icon',
            text: 'Check me out! I\'m a notice.',
            addclass: 'alert bg-danger alert-styled-right stack-top-right',
            type: 'error',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-form').on('click', function () {
        var notice = new PNotify({
            ...
            width: '300px',
            hide: false,
            addclass: 'bg-slate stack-top-right',
            buttons: {
                closer: false,
                sticker: false
            },
    ...
    $('#pnotify-switching').on('click', function () {
        new PNotify({
            ...
            addclass: 'alert bg-primary alert-styled-right stack-top-right',
            stack: stack_top_left,
                ...
                PNotify.update({
                    ...
                    before_close: function(PNotify) {
                        PNotify.update({
                            ...
                            addclass: 'alert bg-success alert-styled-right stack-top-right',
                            type: 'success',
                            stack: stack_top_left,
                            before_close: function(PNotify) {
                                PNotify.update({
                                    ...
                                    addclass: 'alert bg-info alert-styled-right stack-top-right',
                                    type: 'info',
                                    before_close: null,
                                    stack: stack_top_left
                                });
    ...
    function show_stack_top_left(type) {
        var opts = {
            title: "العنوان",
            text: "هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ",
